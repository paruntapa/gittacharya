...
export const aiSummariseCommit = async (diff: string) => {
    // https://github.com/docker/genai-stack/commit/<commmithash>.diff
    const response = await model.generateContent([
        ...
        +++ b/lib/index.js
        \`\`\`
        This means that \`lib/index.js\` was modified in this commit. Note that this is only ab example. 
        ...
        * Moved the \`octokit\` initialization to a separate file [src/octakit.ts], [src/index.ts]
