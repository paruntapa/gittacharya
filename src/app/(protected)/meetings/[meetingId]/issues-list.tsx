...
const IssuesList = ({ meetingId }: Props) => {
  ...
  return (
    <div className='p-8'>
        <div className='mx-auto flex max-w-2xl items-center justify-between gap-x-6 border-b pb-6 lg:mx-0 lg:max-w-none'>
            <div className='flex items-center gap-x-6'>
                <div className='bg-white p-3 border rounded-full'>
                    ...
                    <h1>
                        ...
                        <div className='mt-1 text-base font-semibold text-gray-900 leading-6'>
                            {meeting.name}
        ...
        <div className='grid grid-cols-1 gap-2 sm:grid-cols-3'>
            {meeting.issues.map((issue, Idx  ) => (
                <IssuesCard  key={Idx} issue={issue}/>
            ) )}
...
const IssuesCard = ({ issue }: { issue: NonNullable<RouterOutputs['project']['getMeetingById']>['issues'][number] }) => {
