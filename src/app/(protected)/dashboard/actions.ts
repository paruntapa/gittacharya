...
export async function askQuestion(question: string, projectId: string) {
    ...
    (async ()=> {
        ...
        const { textStream } = await streamText({
            ...
            prompt: `
            You are a ai code assistant who answers questions about the codebase. Your target audience is a technical intern with AI assistant is a brand new, powerful, human-like 
